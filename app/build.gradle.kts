...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = System.getenv("KEY_STORE_PASSWORD") ?: "123456"
            keyAlias = System.getenv("ALIAS") ?: "waduk"
...
dokka {
    ...
    dokkaSourceSets {
        main {
            ...
            sourceLink {
                localDirectory = file("..")
                remoteUrl("https://github.com/nuyuls79/Xstream/tree/master")
                remoteLineSuffix = "#L"
            }
        }
    }
